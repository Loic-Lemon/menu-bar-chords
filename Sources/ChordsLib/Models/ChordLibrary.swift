...
public enum ChordLibrary {
    ...
    public static func chord(root: Note, type: ChordType) -> ChordDefinition? {
        byId["\(root.name)_\(type.rawValue)"]
    }
    ...
    private static let openChords: [ChordDefinition] = [
        ...
        ChordDefinition(id: "A_Major", root: .a, type: .major, positions: [ChordPosition(id: "open", frets: [0, 2, 2, 2, 0, nil], fingers: [nil, 1, 2, 3, nil, nil], baseFret: 1)]),
        ...
        ChordDefinition(id: "A_Minor", root: .a, type: .minor, positions: [ChordPosition(id: "open", frets: [0, 1, 2, 2, 0, nil], fingers: [nil, 1, 2, 3, nil, nil], baseFret: 1)]),
        ...
        ChordDefinition(id: "A7", root: .a, type: .dominant7, positions: [ChordPosition(id: "open", frets: [0, 2, 0, 2, 0, nil], fingers: [nil, 2, nil, 1, nil, nil], baseFret: 1)]),
        ChordDefinition(id: "B7", root: .b, type: .dominant7, positions: [ChordPosition(id: "open", frets: [2, 0, 2, 1, 2, nil], fingers: [2, nil, 3, 1, 4, nil], baseFret: 1)]),
        ChordDefinition(id: "C7", root: .c, type: .dominant7, positions: [ChordPosition(id: "open", frets: [0, 1, 3, 2, 3, nil], fingers: [nil, 1, 3, 2, 4, nil], baseFret: 1)]),
        ...
        ChordDefinition(id: "Amaj7", root: .a, type: .major7, positions: [ChordPosition(id: "open", frets: [0, 2, 1, 2, 0, nil], fingers: [nil, 2, 1, 3, nil, nil], baseFret: 1)]),
        ChordDefinition(id: "Cmaj7", root: .c, type: .major7, positions: [ChordPosition(id: "open", frets: [0, 0, 0, 2, 3, nil], fingers: [nil, nil, nil, 1, 2, nil], baseFret: 1)]),
        ChordDefinition(id: "Dmaj7", root: .d, type: .major7, positions: [ChordPosition(id: "open", frets: [2, 2, 2, 0, nil, nil], fingers: [1, 2, 3, nil, nil, nil], barres: [Barre(fret: 2, startString: 0, endString: 2)], baseFret: 1)]),
        ChordDefinition(id: "Fmaj7", root: .f, type: .major7, positions: [ChordPosition(id: "open", frets: [nil, 1, 2, 3, 0, nil], fingers: [nil, 1, 2, 3, nil, nil], baseFret: 1)]),
        ...
        ChordDefinition(id: "A_Sus2", root: .a, type: .sus2, positions: [ChordPosition(id: "open", frets: [0, 2, 2, 0, 0, nil], fingers: [nil, 2, 3, nil, nil, nil], baseFret: 1)]),
        ChordDefinition(id: "A_Sus4", root: .a, type: .sus4, positions: [ChordPosition(id: "open", frets: [0, 2, 2, 2, 0, nil], fingers: [nil, 1, 2, 3, nil, nil], baseFret: 1)]),
        ...
        ChordDefinition(id: "G_Sus4", root: .g, type: .sus4, positions: [ChordPosition(id: "open", frets: [3, 0, 0, 0, 2, 3], fingers: [3, nil, nil, nil, 1, 2], baseFret: 1)]),
    ]
    ...
    private static let barreChords: [ChordDefinition] = {
        ...
        for (fret, root) in minorRoots {
            chords.append(ChordDefinition(
                ...
                positions: [ChordPosition(id: "e_shape_\(fret)", frets: [fret, fret, fret, fret + 2, fret + 2, fret], fingers: [1, 1, 2, 3, 4, 1], barres: [Barre(fret: fret, startString: 0, endString: 5)], baseFret: fret)]
            ))
        }
        for (fret, root) in aMajorRoots {
            chords.append(ChordDefinition(
                id: "\(root.name)_Major_A_shape_\(fret)", root: root, type: .major,
                positions: [ChordPosition(id: "a_shape_\(fret)", frets: [fret, fret + 2, fret + 2, fret + 2, fret, nil], fingers: [1, 2, 3, 4, 1, nil], barres: [Barre(fret: fret, startString: 0, endString: 4)], baseFret: fret)]
            ))
        }
        for (fret, root) in aMinorRoots {
            chords.append(ChordDefinition(
                id: "\(root.name)_Minor_A_shape_\(fret)", root: root, type: .minor,
                positions: [ChordPosition(id: "a_shape_\(fret)", frets: [fret, fret + 1, fret + 2, fret + 2, fret, nil], fingers: [1, 2, 3, 4, 1, nil], barres: [Barre(fret: fret, startString: 0, endString: 4)], baseFret: fret)]
            ))
        }
        return chords
    }()
